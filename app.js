...
(function(){
  ...
  const GDB = {
    ...
    'Dmaj7':[{frets:[-1,-1,0,2,2,2],  fingers:[0,0,0,1,2,3],  barre:null,            pos:0},
             ...
             {frets:[-1,5,4,2,2,2],   fingers:[0,3,2,1,1,1],  barre:{f:2,a:3,b:5},  pos:2}],
    'Emaj7':[{frets:[0,2,1,1,0,0],    fingers:[0,2,1,1,0,0],  barre:null,            pos:0},
             ...
             {frets:[-1,7,6,4,4,4],   fingers:[0,3,2,1,1,1],  barre:{f:4,a:3,b:5},  pos:4}],
    'Fmaj7':[{frets:[-1,0,3,2,1,0],   fingers:[0,0,3,2,1,0],  barre:null,            pos:0},
             ...
             {frets:[-1,8,7,5,5,5],   fingers:[0,3,2,1,1,1],  barre:{f:5,a:3,b:5},  pos:5}],
    'Gmaj7':[{frets:[3,2,0,0,0,2],    fingers:[3,2,0,0,0,1],  barre:null,            pos:0},
             ...
             {frets:[-1,10,9,7,7,7],  fingers:[0,3,2,1,1,1],  barre:{f:7,a:3,b:5},  pos:7}],
    'Amaj7':[{frets:[-1,0,2,1,2,0],   fingers:[0,0,2,1,3,0],  barre:null,            pos:0},
             ...
             {frets:[-1,12,11,9,9,9], fingers:[0,3,2,1,1,1],  barre:{f:9,a:3,b:5},  pos:9}],
    ...
    'Bb7':   [{frets:[6,8,6,7,6,6],       fingers:[1,3,1,2,1,1],  barre:{f:6,a:0,b:5},  pos:6},
              {frets:[-1,1,3,1,3,1],      fingers:[0,1,3,1,4,1],  barre:{f:1,a:1,b:5},  pos:1}],
    // Major 7th — missing roots (Emaj7 shape + Amaj7 shape barres + Cmaj7 shape mechanical barre)
    'C#maj7':[{frets:[9,11,10,10,9,9],    fingers:[1,3,2,2,1,1],  barre:{f:9,a:0,b:5},  pos:9},
              ...
              {frets:[-1,4,3,1,1,1],      fingers:[0,3,2,1,1,1],  barre:{f:1,a:3,b:5},  pos:1}],
    ...
    'D#maj7':[{frets:[11,13,12,12,11,11], fingers:[1,3,2,2,1,1],  barre:{f:11,a:0,b:5}, pos:11},
              ...
              {frets:[-1,6,5,3,3,3],      fingers:[0,3,2,1,1,1],  barre:{f:3,a:3,b:5},  pos:3}],
    ...
    'F#maj7':[{frets:[2,4,3,3,2,2],       fingers:[1,3,2,2,1,1],  barre:{f:2,a:0,b:5},  pos:2},
              ...
              {frets:[-1,9,8,6,6,6],      fingers:[0,3,2,1,1,1],  barre:{f:6,a:3,b:5},  pos:6}],
    ...
    'G#maj7':[{frets:[4,6,5,5,4,4],       fingers:[1,3,2,2,1,1],  barre:{f:4,a:0,b:5},  pos:4},
              ...
              {frets:[-1,11,10,8,8,8],    fingers:[0,3,2,1,1,1],  barre:{f:8,a:3,b:5},  pos:8}],
    ...
    'A#maj7':[{frets:[6,8,7,7,6,6],       fingers:[1,3,2,2,1,1],  barre:{f:6,a:0,b:5},  pos:6},
              ...
              {frets:[-1,13,12,10,10,10], fingers:[0,3,2,1,1,1],  barre:{f:10,a:3,b:5}, pos:10}],
    ...
    'Bmaj7': [{frets:[7,9,8,8,7,7],       fingers:[1,3,2,2,1,1],  barre:{f:7,a:0,b:5},  pos:7},
              ...
              {frets:[-1,14,13,11,11,11], fingers:[0,3,2,1,1,1],  barre:{f:11,a:3,b:5}, pos:11}],
  ...
  const UDB = {
    ...
    // === mM7 ===  ([n+1,n,n,n] barre str1-3 at n, root on A str)
    'CmM7':  [{frets:[4,3,3,3],   fingers:[4,1,1,1],   barre:{f:3,a:1,b:3},  pos:3}],
    'C#mM7': [{frets:[5,4,4,4],   fingers:[4,1,1,1],   barre:{f:4,a:1,b:3},  pos:4}],
    'DbmM7': [{frets:[5,4,4,4],   fingers:[4,1,1,1],   barre:{f:4,a:1,b:3},  pos:4}],
    'DmM7':  [{frets:[6,5,5,5],   fingers:[4,1,1,1],   barre:{f:5,a:1,b:3},  pos:5}],
    'D#mM7': [{frets:[7,6,6,6],   fingers:[4,1,1,1],   barre:{f:6,a:1,b:3},  pos:6}],
    'EbmM7': [{frets:[7,6,6,6],   fingers:[4,1,1,1],   barre:{f:6,a:1,b:3},  pos:6}],
    'EmM7':  [{frets:[8,7,7,7],   fingers:[4,1,1,1],   barre:{f:7,a:1,b:3},  pos:7}],
    'FmM7':  [{frets:[9,8,8,8],   fingers:[4,1,1,1],   barre:{f:8,a:1,b:3},  pos:8}],
    'F#mM7': [{frets:[10,9,9,9],  fingers:[4,1,1,1],   barre:{f:9,a:1,b:3},  pos:9}],
    'GbmM7': [{frets:[10,9,9,9],  fingers:[4,1,1,1],   barre:{f:9,a:1,b:3},  pos:9}],
    'GmM7':  [{frets:[11,10,10,10],fingers:[4,1,1,1],  barre:{f:10,a:1,b:3}, pos:10}],
    'G#mM7': [{frets:[12,11,11,11],fingers:[4,1,1,1],  barre:{f:11,a:1,b:3}, pos:11}],
    'AbmM7': [{frets:[12,11,11,11],fingers:[4,1,1,1],  barre:{f:11,a:1,b:3}, pos:11}],
    'AmM7':  [{frets:[1,0,0,0],   fingers:[1,0,0,0],   barre:null,            pos:0}],
    'A#mM7': [{frets:[2,1,1,1],   fingers:[4,1,1,1],   barre:{f:1,a:1,b:3},  pos:1}],
    'BbmM7': [{frets:[2,1,1,1],   fingers:[4,1,1,1],   barre:{f:1,a:1,b:3},  pos:1}],
    'BmM7':  [{frets:[3,2,2,2],   fingers:[4,1,1,1],   barre:{f:2,a:1,b:3},  pos:2}],
    // === POWER (5) ===  ([n,n,n+3,n+3] root on C str)
    'C5':    [{frets:[0,0,3,3],   fingers:[0,0,1,2],   barre:null,            pos:0}],
    'C#5':   [{frets:[1,1,4,4],   fingers:[1,2,3,4],   barre:null,            pos:1}],
    'Db5':   [{frets:[1,1,4,4],   fingers:[1,2,3,4],   barre:null,            pos:1}],
    'D5':    [{frets:[2,2,5,5],   fingers:[1,2,3,4],   barre:null,            pos:2}],
    'D#5':   [{frets:[3,3,6,6],   fingers:[1,2,3,4],   barre:null,            pos:3}],
    'Eb5':   [{frets:[3,3,6,6],   fingers:[1,2,3,4],   barre:null,            pos:3}],
    'E5':    [{frets:[4,4,7,7],   fingers:[1,2,3,4],   barre:null,            pos:4}],
    'F5':    [{frets:[5,5,8,8],   fingers:[1,2,3,4],   barre:null,            pos:5}],
    'F#5':   [{frets:[6,6,9,9],   fingers:[1,2,3,4],   barre:null,            pos:6}],
    'Gb5':   [{frets:[6,6,9,9],   fingers:[1,2,3,4],   barre:null,            pos:6}],
    'G5':    [{frets:[7,7,10,10], fingers:[1,2,3,4],   barre:null,            pos:7}],
    'G#5':   [{frets:[8,8,11,11], fingers:[1,2,3,4],   barre:null,            pos:8}],
    'Ab5':   [{frets:[8,8,11,11], fingers:[1,2,3,4],   barre:null,            pos:8}],
    'A5':    [{frets:[9,9,0,0],   fingers:[2,3,0,0],   barre:null,            pos:0}],
    'A#5':   [{frets:[3,5,1,1],   fingers:[3,4,1,2],   barre:null,            pos:1}],
    'Bb5':   [{frets:[3,5,1,1],   fingers:[3,4,1,2],   barre:null,            pos:1}],
    'B5':    [{frets:[4,6,2,2],   fingers:[2,4,1,3],   barre:null,            pos:2}],
    // === 6TH ===  ([n,n,n,n] full barre, root on C str)
    'C6':    [{frets:[0,0,0,0],   fingers:[0,0,0,0],   barre:null,            pos:0}],
    'C#6':   [{frets:[1,1,1,1],   fingers:[1,1,1,1],   barre:{f:1,a:0,b:3},  pos:1}],
    'Db6':   [{frets:[1,1,1,1],   fingers:[1,1,1,1],   barre:{f:1,a:0,b:3},  pos:1}],
    'D6':    [{frets:[2,2,2,2],   fingers:[1,1,1,1],   barre:{f:2,a:0,b:3},  pos:2}],
    'D#6':   [{frets:[3,3,3,3],   fingers:[1,1,1,1],   barre:{f:3,a:0,b:3},  pos:3}],
    'Eb6':   [{frets:[3,3,3,3],   fingers:[1,1,1,1],   barre:{f:3,a:0,b:3},  pos:3}],
    'E6':    [{frets:[4,4,4,4],   fingers:[1,1,1,1],   barre:{f:4,a:0,b:3},  pos:4}],
    'F6':    [{frets:[5,5,5,5],   fingers:[1,1,1,1],   barre:{f:5,a:0,b:3},  pos:5}],
    'F#6':   [{frets:[6,6,6,6],   fingers:[1,1,1,1],   barre:{f:6,a:0,b:3},  pos:6}],
    'Gb6':   [{frets:[6,6,6,6],   fingers:[1,1,1,1],   barre:{f:6,a:0,b:3},  pos:6}],
    'G6':    [{frets:[7,7,7,7],   fingers:[1,1,1,1],   barre:{f:7,a:0,b:3},  pos:7}],
    'G#6':   [{frets:[8,8,8,8],   fingers:[1,1,1,1],   barre:{f:8,a:0,b:3},  pos:8}],
    'Ab6':   [{frets:[8,8,8,8],   fingers:[1,1,1,1],   barre:{f:8,a:0,b:3},  pos:8}],
    'A6':    [{frets:[9,9,9,9],   fingers:[1,1,1,1],   barre:{f:9,a:0,b:3},  pos:9}],
    'A#6':   [{frets:[10,10,10,10],fingers:[1,1,1,1],  barre:{f:10,a:0,b:3}, pos:10}],
    'Bb6':   [{frets:[10,10,10,10],fingers:[1,1,1,1],  barre:{f:10,a:0,b:3}, pos:10}],
    'B6':    [{frets:[11,11,11,11],fingers:[1,1,1,1],  barre:{f:11,a:0,b:3}, pos:11}],

    // m6 (minor 6th = root,b3,P5,M6) — moveable [n+5,n+3,n+3,n] root on G string
    'Cm6':  [{frets:[5,3,3,0],   fingers:[3,1,1,0],  barre:{f:3,a:1,b:2}, pos:0}],
    'C#m6': [{frets:[6,4,4,1],   fingers:[4,2,3,1],  barre:null,           pos:1}],
    'Dbm6': [{frets:[6,4,4,1],   fingers:[4,2,3,1],  barre:null,           pos:1}],
    'Dm6':  [{frets:[7,5,5,2],   fingers:[4,2,3,1],  barre:null,           pos:2}],
    'D#m6': [{frets:[8,6,6,3],   fingers:[4,2,3,1],  barre:null,           pos:3}],
    'Ebm6': [{frets:[8,6,6,3],   fingers:[4,2,3,1],  barre:null,           pos:3}],
    'Em6':  [{frets:[9,7,7,4],   fingers:[4,2,3,1],  barre:null,           pos:4}],
    'Fm6':  [{frets:[10,8,8,5],  fingers:[4,2,3,1],  barre:null,           pos:5}],
    'F#m6': [{frets:[11,9,9,6],  fingers:[4,2,3,1],  barre:null,           pos:6}],
    'Gbm6': [{frets:[11,9,9,6],  fingers:[4,2,3,1],  barre:null,           pos:6}],
    'Gm6':  [{frets:[12,10,10,7],fingers:[4,2,3,1],  barre:null,           pos:7}],
    'G#m6': [{frets:[8,11,11,8], fingers:[1,3,4,2],  barre:{f:11,a:1,b:2},pos:8}],
    'Abm6': [{frets:[8,11,11,8], fingers:[1,3,4,2],  barre:{f:11,a:1,b:2},pos:8}],
    'Am6':  [{frets:[5,4,2,0],   fingers:[4,3,1,0],  barre:null,           pos:0}],
    'A#m6': [{frets:[0,1,1,1],   fingers:[0,1,1,1],  barre:{f:1,a:1,b:3}, pos:0}],
    'Bbm6': [{frets:[0,1,1,1],   fingers:[0,1,1,1],  barre:{f:1,a:1,b:3}, pos:0}],
    'Bm6':  [{frets:[1,2,2,2],   fingers:[1,2,3,4],  barre:null,           pos:1}],

    // add9 (major add9 = root,M3,P5,M9) — moveable [n,n+2,n,n+3] root on A string at n+3
    'Cadd9':  [{frets:[0,2,0,3],   fingers:[0,2,0,3],  barre:null, pos:0}],
    'C#add9': [{frets:[1,3,1,4],   fingers:[1,3,2,4],  barre:null, pos:1}],
    'Dbadd9': [{frets:[1,3,1,4],   fingers:[1,3,2,4],  barre:null, pos:1}],
    'Dadd9':  [{frets:[2,4,2,5],   fingers:[1,3,2,4],  barre:null, pos:2}],
    'D#add9': [{frets:[3,5,3,6],   fingers:[1,3,2,4],  barre:null, pos:3}],
    'Ebadd9': [{frets:[3,5,3,6],   fingers:[1,3,2,4],  barre:null, pos:3}],
    'Eadd9':  [{frets:[4,6,4,7],   fingers:[1,3,2,4],  barre:null, pos:4}],
    'Fadd9':  [{frets:[5,7,5,8],   fingers:[1,3,2,4],  barre:null, pos:5}],
    'F#add9': [{frets:[6,8,6,9],   fingers:[1,3,2,4],  barre:null, pos:6}],
    'Gbadd9': [{frets:[6,8,6,9],   fingers:[1,3,2,4],  barre:null, pos:6}],
    'Gadd9':  [{frets:[2,2,3,2],   fingers:[1,2,4,3],  barre:null, pos:2}],
    'G#add9': [{frets:[8,10,8,11], fingers:[1,3,2,4],  barre:null, pos:8}],
    'Abadd9': [{frets:[8,10,8,11], fingers:[1,3,2,4],  barre:null, pos:8}],
    'Aadd9':  [{frets:[9,11,9,0],  fingers:[2,4,3,0],  barre:null, pos:9}],
    'A#add9': [{frets:[3,2,1,3],   fingers:[3,2,1,4],  barre:null, pos:1}],
    'Bbadd9': [{frets:[3,2,1,3],   fingers:[3,2,1,4],  barre:null, pos:1}],
    'Badd9':  [{frets:[4,3,2,4],   fingers:[3,2,1,4],  barre:null, pos:2}],

    // 7sus4 (dominant 7sus4 = root,P4,P5,b7) — moveable [n,n,n+1,n+1] root on C string at n
    'C7sus4':  [{frets:[0,0,1,1],  fingers:[0,0,1,1],  barre:{f:1,a:2,b:3}, pos:0}],
    'C#7sus4': [{frets:[1,1,2,2],  fingers:[1,1,2,3],  barre:{f:1,a:0,b:1}, pos:1}],
    'Db7sus4': [{frets:[1,1,2,2],  fingers:[1,1,2,3],  barre:{f:1,a:0,b:1}, pos:1}],
    'D7sus4':  [{frets:[2,2,3,3],  fingers:[1,1,2,3],  barre:{f:2,a:0,b:1}, pos:2}],
    'D#7sus4': [{frets:[3,3,4,4],  fingers:[1,1,2,3],  barre:{f:3,a:0,b:1}, pos:3}],
    'Eb7sus4': [{frets:[3,3,4,4],  fingers:[1,1,2,3],  barre:{f:3,a:0,b:1}, pos:3}],
    'E7sus4':  [{frets:[4,4,5,5],  fingers:[1,1,2,3],  barre:{f:4,a:0,b:1}, pos:4}],
    'F7sus4':  [{frets:[5,5,6,6],  fingers:[1,1,2,3],  barre:{f:5,a:0,b:1}, pos:5}],
    'F#7sus4': [{frets:[6,6,7,7],  fingers:[1,1,2,3],  barre:{f:6,a:0,b:1}, pos:6}],
    'Gb7sus4': [{frets:[6,6,7,7],  fingers:[1,1,2,3],  barre:{f:6,a:0,b:1}, pos:6}],
    'G7sus4':  [{frets:[0,2,1,3],  fingers:[0,2,1,3],  barre:null,           pos:0}],
    'G#7sus4': [{frets:[8,8,9,9],  fingers:[1,1,2,3],  barre:{f:8,a:0,b:1}, pos:8}],
    'Ab7sus4': [{frets:[8,8,9,9],  fingers:[1,1,2,3],  barre:{f:8,a:0,b:1}, pos:8}],
    'A7sus4':  [{frets:[0,2,0,0],  fingers:[0,2,0,0],  barre:null,           pos:0}],
    'A#7sus4': [{frets:[1,3,1,1],  fingers:[1,3,1,1],  barre:{f:1,a:0,b:3}, pos:1}],
    'Bb7sus4': [{frets:[1,3,1,1],  fingers:[1,3,1,1],  barre:{f:1,a:0,b:3}, pos:1}],
    'B7sus4':  [{frets:[4,4,2,0],  fingers:[1,1,2,0],  barre:{f:4,a:0,b:1}, pos:0}],

    // 9th (dominant 9th = root,M3,P5,b7,M9) — moveable [n,n+2,n,n+1] root on C string at n
    'C9':   [{frets:[0,2,0,1],   fingers:[0,2,0,1],  barre:null,           pos:0}],
    'C#9':  [{frets:[1,3,1,2],   fingers:[1,4,2,3],  barre:null,           pos:1}],
    'Db9':  [{frets:[1,3,1,2],   fingers:[1,4,2,3],  barre:null,           pos:1}],
    'D9':   [{frets:[2,4,2,3],   fingers:[1,4,2,3],  barre:null,           pos:2}],
    'D#9':  [{frets:[3,5,3,4],   fingers:[1,4,2,3],  barre:null,           pos:3}],
    'Eb9':  [{frets:[3,5,3,4],   fingers:[1,4,2,3],  barre:null,           pos:3}],
    'E9':   [{frets:[4,6,4,5],   fingers:[1,4,2,3],  barre:null,           pos:4}],
    'F9':   [{frets:[5,7,5,6],   fingers:[1,4,2,3],  barre:null,           pos:5}],
    'F#9':  [{frets:[6,8,6,7],   fingers:[1,4,2,3],  barre:null,           pos:6}],
    'Gb9':  [{frets:[6,8,6,7],   fingers:[1,4,2,3],  barre:null,           pos:6}],
    'G9':   [{frets:[0,2,1,0],   fingers:[0,2,1,0],  barre:null,           pos:0}],
    'G#9':  [{frets:[8,10,8,9],  fingers:[1,4,2,3],  barre:null,           pos:8}],
    'Ab9':  [{frets:[8,10,8,9],  fingers:[1,4,2,3],  barre:null,           pos:8}],
    'A9':   [{frets:[9,11,9,10], fingers:[1,4,2,3],  barre:null,           pos:9}],
    'Bb9':  [{frets:[10,0,10,11],fingers:[2,0,3,4],  barre:null,           pos:9}],
    'A#9':  [{frets:[10,0,10,11],fingers:[2,0,3,4],  barre:null,           pos:9}],
    'B9':   [{frets:[2,3,2,4],   fingers:[1,3,2,4],  barre:null,           pos:2}],

    // m9 (minor 9th = root,b3,P5,b7,M9) — moveable [n,n,n,n+2] root on A string at n
    'Am9':  [{frets:[0,0,0,2],   fingers:[0,0,0,2],  barre:null,           pos:0}],
    'Bbm9': [{frets:[1,1,1,3],   fingers:[1,1,1,4],  barre:{f:1,a:0,b:2}, pos:1}],
    'A#m9': [{frets:[1,1,1,3],   fingers:[1,1,1,4],  barre:{f:1,a:0,b:2}, pos:1}],
    'Bm9':  [{frets:[2,2,2,4],   fingers:[1,1,1,4],  barre:{f:2,a:0,b:2}, pos:2}],
    'Cm9':  [{frets:[3,3,3,5],   fingers:[1,1,1,4],  barre:{f:3,a:0,b:2}, pos:3}],
    'C#m9': [{frets:[4,4,4,6],   fingers:[1,1,1,4],  barre:{f:4,a:0,b:2}, pos:4}],
    'Dbm9': [{frets:[4,4,4,6],   fingers:[1,1,1,4],  barre:{f:4,a:0,b:2}, pos:4}],
    'Dm9':  [{frets:[5,5,5,7],   fingers:[1,1,1,4],  barre:{f:5,a:0,b:2}, pos:5}],
    'D#m9': [{frets:[6,6,6,8],   fingers:[1,1,1,4],  barre:{f:6,a:0,b:2}, pos:6}],
    'Ebm9': [{frets:[6,6,6,8],   fingers:[1,1,1,4],  barre:{f:6,a:0,b:2}, pos:6}],
    'Em9':  [{frets:[7,7,7,9],   fingers:[1,1,1,4],  barre:{f:7,a:0,b:2}, pos:7}],
    'Fm9':  [{frets:[8,8,8,10],  fingers:[1,1,1,4],  barre:{f:8,a:0,b:2}, pos:8}],
    'F#m9': [{frets:[9,9,9,11],  fingers:[1,1,1,4],  barre:{f:9,a:0,b:2}, pos:9}],
    'Gbm9': [{frets:[9,9,9,11],  fingers:[1,1,1,4],  barre:{f:9,a:0,b:2}, pos:9}],
    'Gm9':  [{frets:[10,10,10,0],fingers:[2,3,4,0],  barre:null,           pos:9}],
    'G#m9': [{frets:[4,3,2,1],   fingers:[4,3,2,1],  barre:null,           pos:1}],
    'Abm9': [{frets:[4,3,2,1],   fingers:[4,3,2,1],  barre:null,           pos:1}],

    // maj9 (major 9th = root,M3,P5,M7,M9) — moveable [n,n+2,n,n+2] root on C string at n
    'Cmaj9':  [{frets:[0,2,0,2],   fingers:[0,1,0,2],  barre:null, pos:0}],
    'C#maj9': [{frets:[1,3,1,3],   fingers:[1,3,2,4],  barre:null, pos:1}],
    'Dbmaj9': [{frets:[1,3,1,3],   fingers:[1,3,2,4],  barre:null, pos:1}],
    'Dmaj9':  [{frets:[2,4,2,4],   fingers:[1,3,2,4],  barre:null, pos:2}],
    'D#maj9': [{frets:[3,5,3,5],   fingers:[1,3,2,4],  barre:null, pos:3}],
    'Ebmaj9': [{frets:[3,5,3,5],   fingers:[1,3,2,4],  barre:null, pos:3}],
    'Emaj9':  [{frets:[4,6,4,6],   fingers:[1,3,2,4],  barre:null, pos:4}],
    'Fmaj9':  [{frets:[5,7,5,7],   fingers:[1,3,2,4],  barre:null, pos:5}],
    'F#maj9': [{frets:[6,8,6,8],   fingers:[1,3,2,4],  barre:null, pos:6}],
    'Gbmaj9': [{frets:[6,8,6,8],   fingers:[1,3,2,4],  barre:null, pos:6}],
    'Gmaj9':  [{frets:[7,9,7,9],   fingers:[1,3,2,4],  barre:null, pos:7}],
    'G#maj9': [{frets:[8,10,8,10], fingers:[1,3,2,4],  barre:null, pos:8}],
    'Abmaj9': [{frets:[8,10,8,10], fingers:[1,3,2,4],  barre:null, pos:8}],
    'Amaj9':  [{frets:[9,11,9,11], fingers:[1,3,2,4],  barre:null, pos:9}],
    'Bbmaj9': [{frets:[10,0,10,0], fingers:[2,0,3,0],  barre:null, pos:9}],
    'A#maj9': [{frets:[10,0,10,0], fingers:[2,0,3,0],  barre:null, pos:9}],
    'Bmaj9':  [{frets:[4,3,2,1],   fingers:[4,3,2,1],  barre:null, pos:1}],
  };
